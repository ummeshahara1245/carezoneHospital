        ...
        <div>
            ...
            <section className="container py-5">
                <div className="text-center mb-5">
                    <h2 className="fw-bolder display-5 text-uppercase">Medical Departments</h2>
                    <p className="text-secondary lead">The Backbone of our Clinic</p>
                </div>

                {/* Grid Grid for Services */}
                <div className="row row-cols-1 row-cols-md-3 g-4">
                    ...
                    <div className="col">
                        <div className="card h-100 border-0 shadow-sm rounded-3 overflow-hidden">
                            ...
                            <div className="card-body p-4">
                                <h5 className="card-title fw-bold" style={{ color: '#304770' }}>NEURO SURGERY</h5>
                    ...
                    <div className="col">
                        <div className="card h-100 border-0 shadow-sm rounded-3 overflow-hidden">
                            ...
                            />
                            <div className="card-body p-4">
                                <h5 className="card-title fw-bold" style={{ color: '#304770' }}>CARDIAC SURGERY</h5>
                                <p className="card-text text-secondary">
                    ...
                    <div className="col">
                        <div className="card h-100 border-0 shadow-sm rounded-3 overflow-hidden">
                            ...
                            />
                            <div className="card-body p-4">
                                <h5 className="card-title fw-bold" style={{ color: '#304770' }}>MEDICINE</h5>
                                <p className="card-text text-secondary">
            ...
            <section className="bg-light py-5">
                <div className="container">
                    <div className="text-center mb-5">
                        <h2 className="fw-bolder display-5 text-uppercase">About Us</h2>
                    ...
                    <div className="row align-items-center g-5">
                        ...
                        <div className="col-lg-7">
                            <div className="mb-4">
                                <h4 className="fw-bold text-primary">A GLANCE INTO THE PAST</h4>
                                <p className="text-secondary">Back in 1978, with a rental house at Eskaton Garden, Dhaka, a noble gesture, a wise venture of 5 Founder Directors started shaping up. Primarily based on the personal initiative dream and vision and leadership of Dr. A. K. N. Islam (then Chief of Medicine at Holy Family Red Crescent Hospital) all was set to start a private clinic. Throughout the years passed hard work & commitment of the team earned name and fame of the clinic amongst patients & doctors.</p>
                            </div>

                            <div className="mb-4">
                                <h4 className="fw-bold text-primary">A PURPOSE BUILT PRIVATE HOSPITAL</h4>
                                <p className="text-secondary">Defining and redefining the vision in its day-to-day process, the mission was set to shift this clinic to a bigger and better space in view to cater some specific scarce treatment and services. It was 1981 when a land of 1.5 bigha was purchased to construct premises of its own. The venture resulted in the first purpose-built private hospital in Dhaka.</p>
                            </div>

                            <div>
                                <h4 className="fw-bold text-primary">ADVANCED NEURO SURGERY</h4>
                                <p className="text-secondary">Metropolitan Medical Centre from its inception till now has one of the largest neurosurgical centres outside the govt. sector. Prof. Rashiduddin Ahmad, an eminent neurosurgeon of the country, has been associated with this hospital from inception. Gradually the department was enlarged with eminent neurosurgeons rendering valuable services.</p>
                            </div>
                        </div>
